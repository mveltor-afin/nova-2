...
export const TEAM_MEMBERS = {
  ...
  solicitors: [
    ...
    { id:"SOL-02", name:"Blake Lewis LLP",     role:"Conveyancer",     initials:"BL", firm:"Blake Lewis LLP",           sra:"SRA-623456", active:12, capacity:25, specialism:["Residential","BTL","Commercial"], phone:"+44 20 7946 0002", email:"property@blakelewis.com", avgDays:32, rating:4.3 },
    { id:"SOL-03", name:"Carter & Webb",       role:"Conveyancer",     initials:"CW", firm:"Carter & Webb Solicitors",  sra:"SRA-634567", active:6,  capacity:15, specialism:["Residential","Shared Ownership"], phone:"+44 20 7946 0003", email:"conveyancing@carterwebb.co.uk", avgDays:25, rating:4.8 },
    { id:"SOL-04", name:"Deacon Marsh Legal",  role:"Conveyancer",     initials:"DM", firm:"Deacon Marsh Legal",        sra:"SRA-645678", active:10, capacity:18, specialism:["BTL","Commercial","Development"], phone:"+44 20 7946 0004", email:"commercial@deaconmarsh.com", avgDays:35, rating:4.1 },
    { id:"SOL-05", name:"Ellis Wright & Co",   role:"Conveyancer",     initials:"EW", firm:"Ellis Wright & Co",         sra:"SRA-656789", active:4,  capacity:12, specialism:["Residential","Bridging"], phone:"+44 20 7946 0005", email:"fast@elliswright.co.uk", avgDays:18, rating:4.7 },
  ],
};
...
export const MOCK_LOANS = [
  { id: "AFN-2026-00142", customerId: "CUS-002", servicingId: "M-001234", names: "James & Sarah Mitchell", product: "2-Year Fixed", amount: "£350,000", term: "25 yrs", rate: "4.49%", type: "C&I", status: "Underwriting", updated: "2h ago", riskScore: 18, riskLevel: "Low",
    ...
    squad: { adviser:"ADV-01", underwriter:"UW-01", ops:"OPS-01", solicitor:"SOL-01" },
  ...
  { id: "AFN-2026-00139", customerId: "CUS-003", servicingId: "M-001891", names: "Priya Sharma", product: "2-Year Tracker", amount: "£275,000", term: "30 yrs", rate: "5.14%", type: "C&I", status: "Offer_Issued", updated: "1d ago", riskScore: 78, riskLevel: "High",
    ...
    squad: { adviser:"ADV-02", underwriter:"UW-03", ops:"OPS-02", solicitor:"SOL-02" },
    brokerChannel: { type:"AR", firm:"Watson Mortgages Ltd", fca:"AR-820341", network:"Stonebridge Mortgage Solutions", networkFca:"FCA-163863", networkContact:"Broker Support", networkPhone:"01604 858060", networkEmail:"broker.support@stonebridgegroup.co.uk" } },
  { id: "AFN-2026-00135", customerId: "CUS-004", servicingId: "M-002456", names: "David Chen", product: "5-Year Fixed", amount: "£425,000", term: "25 yrs", rate: "5.69%", type: "Interest Only", status: "KYC_In_Progress", updated: "3d ago", riskScore: 12, riskLevel: "Low",
    ...
    squad: { adviser:"ADV-03", underwriter:"UW-02", ops:"OPS-02", solicitor:"SOL-02" },
    brokerChannel: { type:"AR", firm:"Meridian Finance Group", fca:"AR-734908", network:"Beneficial Mortgages", networkFca:"FCA-301244", networkContact:"Account Management", networkPhone:"01244 394994", networkEmail:"am.team@beneficial.co.uk" } },
  { id: "AFN-2026-00128", customerId: "CUS-001", servicingId: "M-002891", names: "Emma Wilson", product: "2-Year Fixed", amount: "£290,000", term: "20 yrs", rate: "4.19%", type: "C&I", status: "Disbursed", updated: "1w ago", riskScore: 14, riskLevel: "Low",
    ...
    squad: { adviser:"ADV-01", underwriter:"UW-01", ops:"OPS-01", solicitor:"SOL-01" },
    brokerChannel: { type:"DA", firm:"Oakbridge Financial Services", fca:"FCA-487231", contact:"Sarah Thompson", phone:"01179 560400", email:"s.thompson@oakbridgefs.co.uk" } },
  { id: "AFN-2026-00125", customerId: "CUS-005", servicingId: "M-003567", names: "Aisha Patel", product: "2-Year Fixed", amount: "£510,000", term: "25 yrs", rate: "3.69%", type: "C&I", status: "Approved", updated: "4d ago", riskScore: 22, riskLevel: "Low",
    ...
    squad: { adviser:"ADV-03", underwriter:"UW-02", ops:"OPS-03", solicitor:"SOL-03" },
    brokerChannel: { type:"AR", firm:"Premier Mortgage Advisers", fca:"AR-810562", network:"HLP (Intrinsic)", networkFca:"FCA-113925", networkContact:"Broker Support Team", networkPhone:"01483 461461", networkEmail:"support@hlp.co.uk" } },
  { id: "AFN-2026-00119", customerId: "CUS-006", servicingId: "M-003124", names: "Robert Hughes", product: "2-Year Fixed", amount: "£180,000", term: "15 yrs", rate: "5.69%", type: "C&I", status: "Referred", updated: "5d ago", riskScore: 82, riskLevel: "High",
    bucket: "Buy-to-Let", bucketColor: "#F59E0B", tier: "Adverse Credit", code: "B2F", erc: "3%, 2%", productFee: "£1,995", creditProfile: "adverse", propertyType: "Non-Standard", epcRating: "F", ltv: 65,
    squad: { adviser:"ADV-02", underwriter:"UW-02", ops:"OPS-01", solicitor:"SOL-04" },
    brokerChannel: { type:"Packager", firm:"Riverside Finance Ltd", fca:"AR-991234", packager:"Brightstar Financial", packagerFca:"FCA-743458", packagerContact:"Ryan Archer", packagerPhone:"01277 500900", packagerEmail:"ryan.archer@brightstar.co.uk" } },
  { id: "AFN-2026-00115", customerId: null, servicingId: "M-003890", names: "Sophie & Jack Brown", product: "2-Year Fixed", amount: "£320,000", term: "30 yrs", rate: "5.59%", type: "C&I", status: "DIP_Approved", updated: "6d ago", riskScore: 45, riskLevel: "Medium",
    ...
    squad: { adviser:"ADV-01", underwriter:"UW-03", ops:"OPS-03", solicitor:"SOL-03" },
    brokerChannel: { type:"DA", firm:"Harper Wealth Solutions", fca:"FCA-512890", contact:"Daniel Marsh", phone:"0161 834 5500", email:"d.marsh@harperwealthsolutions.co.uk" } },
  ...
  { id: "AFN-2026-00144", customerId: "CUS-009", servicingId: null, names: "GreenLeaf Properties Ltd", product: "Tracker", amount: "£240,000", term: "20 yrs", rate: "5.64%", type: "BTL", status: "Underwriting", updated: "4h ago", riskScore: 38, riskLevel: "Medium",
    ...
    squad: { adviser:"ADV-03", underwriter:"UW-02", ops:"OPS-03", solicitor:"SOL-03" },
    brokerChannel: { type:"AR", firm:"GreenLeaf Mortgage Advisers", fca:"AR-895021", network:"Stonebridge Mortgage Solutions", networkFca:"FCA-163863", networkContact:"Broker Support", networkPhone:"01604 858060", networkEmail:"broker.support@stonebridgegroup.co.uk" } },
  { id: "AFN-2026-00145", customerId: "CUS-010", servicingId: null, names: "Bright Futures Consulting Ltd", product: "2-Year Fixed", amount: "£340,000", term: "15 yrs", rate: "5.49%", type: "Commercial", status: "Approved", updated: "2d ago", riskScore: 25, riskLevel: "Low",
    ...
    squad: { adviser:"ADV-02", underwriter:"UW-01", ops:"OPS-02", solicitor:"SOL-02" },
    brokerChannel: { type:"Packager", firm:"Nexus Commercial Finance", fca:"AR-884320", packager:"Crystal Specialist Finance", packagerFca:"FCA-580342", packagerContact:"Michelle Fox", packagerPhone:"01827 662440", packagerEmail:"m.fox@crystalspecialist.co.uk" } },
  { id: "AFN-2026-00146", customerId: null, servicingId: null, names: "Sarah & Tom Reynolds", product: "Regulated Bridge", amount: "£425,000", term: "12 mo", rate: "0.65%/mo", type: "Bridging", status: "KYC_In_Progress", updated: "1d ago", riskScore: 42, riskLevel: "Medium",
    ...
    squad: { adviser:"ADV-01", underwriter:"UW-02", ops:"OPS-01", solicitor:"SOL-05" },
    brokerChannel: { type:"Packager", firm:"Reynolds & Co Mortgage Consultants", fca:"AR-773056", packager:"Crystal Specialist Finance", packagerFca:"FCA-580342", packagerContact:"Michelle Fox", packagerPhone:"01827 662440", packagerEmail:"m.fox@crystalspecialist.co.uk" } },
  { id: "AFN-2026-00147", customerId: null, servicingId: null, names: "Orion Developments Ltd (SPV)", product: "Development Facility", amount: "£1,800,000", term: "18 mo", rate: "7.20%", type: "Development", status: "Submitted", updated: "3d ago", riskScore: 55, riskLevel: "Medium",
    ...
    squad: { adviser:"ADV-03", underwriter:"UW-02", ops:"OPS-03", solicitor:"SOL-03" },
    brokerChannel: { type:"Packager", firm:"Apex Property Finance", fca:"AR-662189", packager:"Brightstar Financial", packagerFca:"FCA-743458", packagerContact:"Ryan Archer", packagerPhone:"01277 500900", packagerEmail:"ryan.archer@brightstar.co.uk" } },
];
